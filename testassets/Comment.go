...
func (c *Comment) Create(db query.IDB) error {
	return nil
}

func (c *Comment) Update(db query.IDB) error {
	return nil
}

func (c *Comment) Delete(db query.IDB) error {
	return nil
}

func (c *Comment) FromID(db query.IDB, id int64) (query.IModel, error) {
	return nil, nil
}
